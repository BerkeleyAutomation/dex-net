# -*- coding: utf-8 -*-
#
# Dex-Net documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'Dex-Net.tex', u'Dex-Net Documentation',
...
man_pages = [
    (master_doc, 'dex-net', u'Dex-Net Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Dex-Net', u'Dex-Net Documentation',
     author, 'Dex-Net', 'One line description of project.',
     'Miscellaneous'),
]
