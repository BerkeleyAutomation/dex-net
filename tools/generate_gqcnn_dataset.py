...
from perception import CameraIntrinsics, RenderMode, BinaryImage, DepthImage
                    ...
                    if stable_pose.p > stable_pose_min_p:
                        ...
                        for aligned_grasp in aligned_grasps:
                            ...
                            if collision_free and config['vis']['candidate_grasps']:
                                ...
                                vis.figure()
                                vis.gripper_on_object(gripper, aligned_grasp, obj, stable_pose)
                                vis.show()
                    ...
                    for render_sample in render_samples:
                        ...
                        for grasp_info in candidate_grasp_info:
                            ...
                            if config['vis']['grasp_images']:
                                ...
                                vis.figure()
                                T_obj_world = vis.mesh_stable_pose(obj.mesh, stable_pose, style='surface', dim=0.5)
